...
public class ChessBehaviour : MonoBehaviour {
    ...
    public static bool TestRand(ref int[][] generatedPairs, int sign, int MyModuleId, out string boardString) {
        boardString = "";
        ...
        try {
            ...
            myPieces[1] = new ChessPiece(randPieces[1] / 10, randPieces[1] % 10, (sign == 0 ? ChessPieceType.Knight : ChessPieceType.Rook), ref chessBoard);
            myPieces[3] = new ChessPiece(randPieces[3] / 10, randPieces[3] % 10, ChessPieceType.Rook, ref chessBoard);
            if (ChessPiece.GetWhite(randPieces[4] / 10, randPieces[4] % 10)) {
